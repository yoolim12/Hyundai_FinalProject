...
import com.hyundai.project.service.RegisterServiceImpl;

import lombok.extern.log4j.Log4j2;

@Controller
@Log4j2
@RequestMapping("/HandsomeLogin")
...
//	@PreAuthorize("permitAll()")
	@RequestMapping("/HandsomeLoginpage")
	public void loginpage(Model model, @RequestParam(value="error", required=false) String error) {
		if(error != null) {
	...
	public String loginfail(Model model) {
		...
		return "/HandsomeLogin/HandsomeLoginpage";
	}
